...
NEWLINE_TYPES = ['STRLIT', 'WS']
IGNORE_TYPES = ['WS']
LEXERS = {}
MRES = (
[('(?P<WS>(?:[ \t\x0c\r\n])+)|(?P<VALUE>value)|(?P<ENUM>enum)|(?P<RULE>rule)',
  {1: 'WS', 2: 'VALUE', 3: 'ENUM', 4: 'RULE'})]
)
LEXER_CALLBACK = (
{}
)
...
MRES = (
[('(?P<NAME>(?:_|(?:[A-Z]|[a-z]))(?:(?:(?:_|(?:[A-Z]|[a-z]))|[0-9]))*)|(?P<WS>(?:[ \t\x0c'
  '\r\n'
  '])+)',
  {1: 'NAME', 2: 'WS'})]
)
...
RULES = {
  0: Rule(NonTerminal('start'), [], None, RuleOptions(False, False, None)),
  1: Rule(NonTerminal('start'), [NonTerminal('__anon_star_0')], None, RuleOptions(False, False, None)),
  2: Rule(NonTerminal('decl'), [NonTerminal('value_decl')], None, RuleOptions(False, True, None)),
  3: Rule(NonTerminal('decl'), [NonTerminal('rule_decl')], None, RuleOptions(False, True, None)),
  4: Rule(NonTerminal('decl'), [NonTerminal('enum_decl')], None, RuleOptions(False, True, None)),
  5: Rule(NonTerminal('enum_decl'), [Terminal('ENUM', True), Terminal('NAME', False), NonTerminal('enum_body')], None, RuleOptions(False, False, None)),
  6: Rule(NonTerminal('enum_body'), [Terminal('LBRACE', True), NonTerminal('enum_items'), Terminal('RBRACE', True)], None, RuleOptions(False, True, None)),
  7: Rule(NonTerminal('enum_body'), [Terminal('SEMICOLON', True)], None, RuleOptions(False, True, None)),
  ...
  10: Rule(NonTerminal('value_decl'), [Terminal('VALUE', True), Terminal('NAME', False), Terminal('SEMICOLON', True)], None, RuleOptions(False, False, None)),
  11: Rule(NonTerminal('rule_decl'), [Terminal('RULE', True), Terminal('NAME', False), Terminal('COLON', True), NonTerminal('rule_body'), Terminal('SEMICOLON', True)], None, RuleOptions(False, False, None)),
  12: Rule(NonTerminal('rule_body'), [NonTerminal('rule_lhs'), Terminal('__ANON_0', True), NonTerminal('rule_rhss')], None, RuleOptions(False, False, None)),
  13: Rule(NonTerminal('rule_lhs'), [Terminal('NAME', False)], None, RuleOptions(False, True, None)),
  14: Rule(NonTerminal('rule_rhss'), [NonTerminal('rule_rhs')], None, RuleOptions(False, False, None)),
  15: Rule(NonTerminal('rule_rhss'), [NonTerminal('rule_rhs'), NonTerminal('__anon_star_2')], None, RuleOptions(False, False, None)),
  16: Rule(NonTerminal('rule_rhs'), [Terminal('NAME', False)], None, RuleOptions(False, True, None)),
  17: Rule(NonTerminal('enum_item'), [Terminal('STRLIT', False)], None, RuleOptions(False, True, None)),
  18: Rule(NonTerminal('__anon_star_0'), [NonTerminal('__anon_star_0'), NonTerminal('decl')], None, None),
  19: Rule(NonTerminal('__anon_star_0'), [NonTerminal('decl')], None, None),
  20: Rule(NonTerminal('__anon_star_1'), [NonTerminal('__anon_star_1'), Terminal('COMMA', True), NonTerminal('enum_item')], None, None),
  21: Rule(NonTerminal('__anon_star_1'), [Terminal('COMMA', True), NonTerminal('enum_item')], None, None),
  22: Rule(NonTerminal('__anon_star_2'), [Terminal('STAR', True), NonTerminal('rule_rhs')], None, None),
  23: Rule(NonTerminal('__anon_star_2'), [NonTerminal('__anon_star_2'), Terminal('STAR', True), NonTerminal('rule_rhs')], None, None),
}
parse_tree_builder = ParseTreeBuilder(RULES.values(), Tree)
class ParseTable: pass
parse_table = ParseTable()
STATES = {
  0: {0: (1, 0), 1: (0, 1), 2: (0, 2), 3: (0, 3), 4: (0, 4), 5: (0, 5), 6: (0, 6), 7: (0, 7), 8: (0, 8), 9: (0, 9)},
  1: {0: (1, 1), 2: (0, 2), 5: (0, 5), 6: (0, 6), 7: (0, 7), 8: (0, 8), 3: (0, 10), 9: (0, 9)},
  2: {10: (0, 11)},
  3: {2: (1, 19), 9: (1, 19), 0: (1, 19), 7: (1, 19)},
  4: {0: (0, 12)},
  5: {2: (1, 4), 9: (1, 4), 0: (1, 4), 7: (1, 4)},
  6: {2: (1, 2), 9: (1, 2), 0: (1, 2), 7: (1, 2)},
  7: {10: (0, 13)},
  8: {2: (1, 3), 9: (1, 3), 0: (1, 3), 7: (1, 3)},
  9: {10: (0, 14)},
  10: {2: (1, 18), 9: (1, 18), 0: (1, 18), 7: (1, 18)},
  11: {11: (0, 15)},
  12: {},
  13: {12: (0, 16)},
  14: {11: (0, 17), 13: (0, 18), 14: (0, 19)},
  15: {2: (1, 10), 9: (1, 10), 0: (1, 10), 7: (1, 10)},
  16: {15: (0, 20), 10: (0, 21), 16: (0, 22)},
  17: {2: (1, 7), 9: (1, 7), 0: (1, 7), 7: (1, 7)},
  18: {2: (1, 5), 9: (1, 5), 0: (1, 5), 7: (1, 5)},
  19: {17: (0, 23), 18: (0, 24), 19: (0, 25)},
  20: {20: (0, 26)},
  21: {20: (1, 13)},
  22: {11: (0, 27)},
  23: {21: (0, 28)},
  24: {22: (1, 17), 21: (1, 17)},
  25: {21: (1, 9), 23: (0, 29), 22: (0, 30)},
  26: {10: (0, 31), 24: (0, 32), 25: (0, 33)},
  27: {2: (1, 11), 9: (1, 11), 0: (1, 11), 7: (1, 11)},
  28: {2: (1, 6), 9: (1, 6), 0: (1, 6), 7: (1, 6)},
  29: {21: (1, 8), 22: (0, 34)},
  30: {18: (0, 24), 19: (0, 35)},
  31: {11: (1, 16), 26: (1, 16)},
  32: {11: (1, 14), 27: (0, 36), 26: (0, 37)},
  33: {11: (1, 12)},
  34: {18: (0, 24), 19: (0, 38)},
  35: {22: (1, 21), 21: (1, 21)},
  36: {11: (1, 15), 26: (0, 39)},
